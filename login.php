...
if(isset($_POST['submit'])) {
    ...
    if (count($errors) == 0) {
        ...
        $sql = "SELECT gebruikersnaam, wachtwoord, id FROM kampeerder  WHERE gebruikersnaam = ? AND wachtwoord = ?";
...
<html lang="nl">
    ...
    <div class="blockform">
        <form method="post">
        <div class="title"><h1>Inloggen</h1></div>
            ...
            <a class="admin" href="index.php?page=werknemerlogin">Werknemer?</a>
        </form>
    </div>
    </body>
</html>